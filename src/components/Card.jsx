                ...
                <div class="card border-0 px-3">
                  <div>
                    <svg
                      ...
                      aria-hidden="true"
                      role="img"
                      class="display-1 iconify iconify--emojione-monotone"
                      width="1em"
                      height="1em"
                ...
                <div class="card border-0 px-3">
                  <div>
                    <svg
                      ...
                      aria-hidden="true"
                      role="img"
                      class="display-1 iconify iconify--la"
                      width="1em"
                      height="1em"
                      preserveAspectRatio="xMidYMid meet"
                      viewBox="0 0 32 32"
                ...
                <div class="card border-0 px-3">
                  <div>
                    <svg
                      ...
                      aria-hidden="true"
                      role="img"
                      class="display-1 iconify iconify--ph"
                      width="1em"
                      height="1em"
                      preserveAspectRatio="xMidYMid meet"
                      viewBox="0 0 256 256"
                    >
                      <path
                        fill="currentColor"
                        d="M244 128a52 52 0 0 1-88.77 36.77l-.17-.18L95 96.8a44 44 0 1 0 0 62.4l8.6-9.72a4 4 0 0 1 6 5.3l-8.68 9.81l-.17.18a52 52 0 1 1 0-73.54l.17.18l60 67.79a44 44 0 1 0 0-62.4l-8.6 9.72a4 4 0 0 1-6-5.3l8.68-9.81l.17-.18A52 52 0 0 1 244 128Z"
                      ></path>
                    </svg>
                  </div>
                  <div class="title">
